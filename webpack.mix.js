...
/*
 ...
 | -----------------------------------------------
 | Using your view with mix('css/marketing.css', 'vendor/marketing')
...
mix
    .postCss('resources/css/marketing.css', 'css', [require('tailwindcss')('tailwind.config.js')])
    // .js('resources/js/marketing.js', 'js')
    .version()
